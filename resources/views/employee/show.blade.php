...
<body>
    ...
    <div data-role="page" data-add-back-btn="true" data-theme="c">
		...
		<div data-role="footer">
				<input type="button" onclick="location='/employee/{{ $emp->employeeId }}/edit'" class="btn btn-danger" value="Edit">
				<input type="button" onclick="location='/employee'" class="btn btn-danger" value="Back">
			</div>
    </div>
</body>
</html>